...
def getSensorReading(sensor):
    def getObstacleDist(sensorHandler_):
        ...
        if rawSR[1]: # if true, obstacle is within detection range, return distance to obstacle
            ...
            return float('inf')
    if sensor=="ultraSonicSensorLeft0":
        return getObstacleDist(robot.ultraSonicSensorLeft0)
    ...
    elif sensor=="ultraSonicSensorFront":
        return getObstacleDist(robot.ultraSonicSensorFront)
...
def init():
    ...
    if clientID != -1:
        ...
        if res == vrep.simx_return_ok: # Remote function call succeeded
            ...
            ret_sl0,  ultraSonicSensorLeft0 = vrep.simxGetObjectHandle(clientID, 'Pioneer_p3dx_ultrasonicSensor1',vrep.simx_opmode_oneshot_wait)
            ...
            ret_sf, ultraSonicSensorFront = vrep.simxGetObjectHandle(clientID, 'Pioneer_p3dx_ultrasonicSensor4', vrep.simx_opmode_oneshot_wait)
            blockHandleArray = []
            ...
            robot = EasyDict(clientID=clientID,
                             ...
                             ultraSonicSensorLeft0=ultraSonicSensorLeft0,
                             ultraSonicSensorLeft=ultraSonicSensorLeft,
                             ultraSonicSensorRight=ultraSonicSensorRight,
                             ultraSonicSensorFront=ultraSonicSensorFront,
                             energySensor=None)
