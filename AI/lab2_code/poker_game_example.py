    ...
    if round_init:
        ...
        for _state_ in states_:
            if _state_.phase == 'SHOWDOWN' and (_state_.opponent.stack <= 300 or _state_.agent.stack <= 300): #or _state_.MAX_HANDS >= 4):
                    end_state_ = _state_
                    #agent_money = _state_.agent.stack
                    #opponent_money = _state_.opponent.stack
                    game_on = False
...
print(nn_level, 'level')
#print('Agent money', agent_money)
#print('Opponent money', opponent_money)
